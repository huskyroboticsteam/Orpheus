...
namespace RoverPathfinding
{
	...
	bool segment_circle_intersection(point start, point end, point circle, float R); //Unused. Tells whether a line segment intersects with a circle of radius R with center at point "circle"
	...
	int create_node(point coord); //Creates a node
